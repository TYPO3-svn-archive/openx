...
class tx_OpenxDllCampaignInfo extends tx_OpenxInfo
{
    /**
    ...
    function setDefaultForAdd() {
        if (is_null($this->startDate)) {
            $this->startDate = new Date(tx_OpenxDal::noDateValue());
        }

        if (is_null($this->endDate)) {
            $this->endDate = new Date(tx_OpenxDal::noDateValue());
        }
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/CampaignInfo.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/CampaignInfo.php']);
}
?>