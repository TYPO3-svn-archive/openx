...
+---------------------------------------------------------------------------+
$Id: openads-xmlrpc.inc.php 22929 2008-07-21 14:01:02Z david.keen@openx.org $
*/
...
class tx_OpenxXmlRpc
{
     ...
     *
     * @see tx_OpenxXmlRpc::__construct
     */
    function tx_OpenxXmlRpc($host, $path, $port = 0, $ssl = false, $timeout = 15)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/openads-xmlrpc.inc.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/openads-xmlrpc.inc.php']);
}
?>
