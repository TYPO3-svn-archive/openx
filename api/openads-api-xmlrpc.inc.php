...
+---------------------------------------------------------------------------+
$Id: openads-api-xmlrpc.inc.php 22929 2008-07-21 14:01:02Z david.keen@openx.org $
*/
...
class tx_OpenxApiXmlrpc
{
     ...
     */
    function tx_OpenxApiXmlrpc($host, $basepath, $username, $password, $port = 0, $ssl = false, $timeout = 15)
    {
        $this->host = $host;
    ...
    function _send($service, $method, $data)
    {
        ...
        foreach ($data as $element) {
            if (is_object($element) && is_subclass_of($element, 'tx_OpenxInfo')) {
     ...
     *
     * @param tx_OpenxDllAgencyInfo $oAgencyInfo
     ...
     *
     * @param int $agencyId
     * @return array  array tx_OpenxDllAgencyInfo objects
     */
     ...
     *
     * @param tx_OpenxDllAdvertiserInfo $oAdvertiserInfo
     *
     * @return  method result
     */
     ...
     *
     * @return tx_OpenxDllAdvertiserInfo
     */
    function getAdvertiser($advertiserId)
    {
        ...
        $oAdvertiserInfo = new tx_OpenxDllAdvertiserInfo();
     ...
     *
     * @param tx_OpenxDllCampaignInfo $oCampaignInfo
     *
     * @return  method result
     */
     ...
     * @param int $campaignId
     *
     * @return array  array tx_OpenxDllCampaignInfo objects
     */
     ...
     *
     * @param tx_OpenxDllBannerInfo $oBannerInfo
     *
     * @return  method result
     */
     ...
     *
     * @param tx_OpenxDllPublisherInfo $oPublisherInfo
     * @return  method result
     */
     ...
     * @return tx_OpenxDllPublisherInfo
     */
    function getPublisher($publisherId)
    {
        ...
        $oPublisherInfo = new tx_OpenxDllPublisherInfo();
     ...
     *
     * @param int $agencyId
     * @return array  array tx_OpenxDllPublisherInfo objects
     */
     ...
     *
     * @param tx_OpenxDllUserInfo $oUserInfo
     * @return  method result
     */
     ...
     * @param int $accountId
     *
     * @return array  array tx_OpenxDllUserInfo objects
     */
     ...
     *
     * @param tx_OpenxDllZoneInfo $oZoneInfo
     * @return  method result
     */
     ...
     *
     * @param int $publisherId
     * @return array  array tx_OpenxDllZoneInfo objects
     */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/openads-api-xmlrpc.inc.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/openx/api/openads-api-xmlrpc.inc.php']);
}
?>